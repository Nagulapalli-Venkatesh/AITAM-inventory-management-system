...
<form action="ablockentry.php" method="POST">
            ...
            $sql = mysqli_query($conn, $oquery);
              while($row = mysqli_fetch_array($sql)){
               ...
               echo " <tr><th>".$row['sno']."</th><td>".$row['date']."</td><td>".$row['infra']."</td>
                        ...
                        <td>".$row['purpose']."<td>".$row['temper']."</td><td><a href='ablockremove.php?k=".$row['sno']."'><b>Remove</b><td><a href='#.php?k=".$row['sno']."'><b>REPAIR</b></td></tr>";
              }
         ?>
  </tbody>
</table>
