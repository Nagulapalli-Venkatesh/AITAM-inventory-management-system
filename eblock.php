...
<form action="eblockentry.php" method="POST">
...
<table class="table table-hover table-bordered results">
  ...
  <tbody>
   <?PHP
             include 'connect.php';
            $oquery = "SELECT * FROM `eblock`  ORDER BY `sno` DESC";
            $sql = mysqli_query($conn, $oquery);
              while($row = mysqli_fetch_array($sql)){
               ...
               echo " <tr><th>".$row['sno']."</th><td>".$row['date']."</td><td>".$row['infra']."</td>
                        ...
                        <td>".$row['purpose']."<td>".$row['temper']."</td><td><a href='eblockremove.php?k=".$row['sno']."'><b>Remove</b><td><a href='#.php?k=".$row['sno']."'><b>REPAIR</b></td></tr>";
              }
         ?>
  </tbody>
</table>
